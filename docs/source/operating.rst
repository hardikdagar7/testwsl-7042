[testwsl-7042] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [testwsl-7042] container is NOT running**.

.. tip::
   You must have your [testwsl-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38121  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hardikdagar0207'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hardikdagar0207/testwsl-7042-amd64 (https://hub.docker.com/r/hardikdagar0207/testwsl-7042-amd64)
...
.. important::
   docker run -d -p 41149:41149 -p 33029:33029 -p 54779:54779 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=testwsl-7042 \-\-env SOLUTIONDAG=solution_preprocessing_ml_ai_mqtt_dag-testwsl-7042 \-\-env GITUSERNAME=hardikdagar7  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=41149  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=33029  \-\-env SOLUTIONVIPERVIZPORT=54779 \-\-env DOCKERUSERNAME='hardikdagar0207' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=38121 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hardikdagar0207' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hardikdagar0207/testwsl-7042-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hardikdagar0207/testwsl-7042-amd64
...
[testwsl-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/testwsl-7042
...
.. important::
   https://testwsl-7042.readthedocs.io
...
.. important::
   solution_preprocessing_ml_ai_mqtt_dag-testwsl-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=41149, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46101, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33627, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=44323, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46257, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40409, HPDEHOST=127.0.1.1, HPDEPORT=39645, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37019

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5505-testwsl-7042,solution_preprocessing_ml_ai_mqtt_dag-testwsl-7042, python-preprocess-99-testwsl-7042,solution_preprocessing_ml_ai_mqtt_dag-testwsl-7042, python-ml-428-testwsl-7042,solution_preprocessing_ml_ai_mqtt_dag-testwsl-7042, python-predict-480-testwsl-7042,solution_preprocessing_ml_ai_mqtt_dag-testwsl-7042, python-ai-8438-testwsl-7042,solution_preprocessing_ml_ai_mqtt_dag-testwsl-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
